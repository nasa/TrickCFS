...
class SchLabTrickCFSSchedulerEquuleusRC1 : public BaseTrickCFSScheduler
{
public:
    SchLabTrickCFSSchedulerEquuleusRC1();
    virtual ~SchLabTrickCFSSchedulerEquuleusRC1();
...
private:
    SchLabTrickCFSSchedulerEquuleusRC1(const SchLabTrickCFSSchedulerEquuleusRC1 & other);
    SchLabTrickCFSSchedulerEquuleusRC1 & operator=(const SchLabTrickCFSSchedulerEquuleusRC1 & other);
};
